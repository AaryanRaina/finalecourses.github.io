const STORE = {
 questions: {
  accessibility: [
   {
    question: "What is an example of ideas or actions that are part of the drug culture?",
    code: ` `,
    answers: [
     "Drug dealers portrayed as heroes in TV shows and movies",
     "Attending all night parties where drugs are part of the experience",
     "Pharmaceutical drugs advertised on radio, television and in magazines",
     "Songs that promote the use of drugs",
     "All of the above"
    ],
  ...
  arrays: [
   {
    question: "How do drugs affect the mind?",
    code: ` `,
    answers: [
     "They don’t affect the mind at all",
     "They improve creativity",
     "They blur memory, wipe out ability, muddy one’s thinking and can distort the perception of what is happening around one",
     "They make a person smarter and able to make correct decisions about things"
    ],
    correctAnswer: "They blur memory, wipe out ability, muddy one’s thinking and can distort the perception of what is happening around one"
   }],

  elements: [
    {
        question: "How did drugs become so widespread in society?",
        code: ` `,
        answers: [
         "Drugs were popularized in the 1960s by music and mass media",
         "Part of the industrial revolution included better and faster methods of producing drugs",
         "Advances in science resulted in the discovery of many new drugs",
         "With the increase in automation, there was less need for people to work and they didn’t have enough to do, got bored and started doing drugs"
        ],
        correctAnswer: "Drugs were popularized in the 1960s by music and mass media"
      }

  ],
  flexbox: [
    {
        question: "The most commonly used and abused drug is alcohol.",
        code: ``,
        answers: [
         "True",
         "False"
  ...
  forms: [
    {
        question: "What are some of the reasons young people take drugs?",
        code: ``,
        answers: [
         "To be cool, accepted by their friends or to fit in",
         "To feel better or escape their problems",
         "To relieve boredom or experiment",
         "To seem grown up or rebel",
         "All of the above"
        ],
        correctAnswer: "All of the above"
       }
  ...
  loops: [
    {
        question: "A drug can act as a stimulant, a sedative or can kill you, depending on the amount taken.",
        code: ``,
        answers: [
            "True",
            "False"
